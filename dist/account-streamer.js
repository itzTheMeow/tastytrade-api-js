...
export class AccountStreamer {
     ...
     */
    constructor(url, httpClient, logger, heartbeatInterval = DEFAULT_HEARTBEAT_INTERVAL) {
        this.url = url;
    ...
    scheduleHeartbeatTimer() {
        ...
        this.heartbeatTimerId = scheduler(this.sendHeartbeat, this.heartbeatInterval);
    }
     ...
     * @returns
     */
    async subscribeTo(action, value) {
     ...
     */
    async subscribeToUser(userExternalId) {
        if (!userExternalId) {
